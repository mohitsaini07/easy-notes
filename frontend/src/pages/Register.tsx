    ...
    <div className="min-h-screen flex items-center justify-center bg-secondary/30 relative overflow-hidden p-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground font-medium">Join 50,000+ students and start sharing.</p>
        </div>
        ...
        <div className="bg-card border border-border p-10 rounded-[3rem] shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={submitHandler} className="space-y-6">
            <div>
              <label className="block text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-2 ml-1">Full Name</label>
